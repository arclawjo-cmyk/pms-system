        ...
        <div class="px-3 py-4 overflow-y-auto h-[calc(100vh-4rem)] flex flex-col">
            <nav class="space-y-1 flex-1">
                <a
                    ...
                    <?php echo e(request()->routeIs('admin.dashboard') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-100'); ?>"
                >
                    <svg class="w-5 h-5 <?php echo e(request()->routeIs('admin.dashboard') ? 'text-blue-600' : 'text-gray-500 group-hover:text-gray-700'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a
                    ...
                    class="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition
                    <?php echo e(request()->routeIs('admin.colleges.*') || request()->routeIs('admin.offices.*') || request()->routeIs('admin.staff.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-100'); ?>"
                >
                    <svg class="w-5 h-5 <?php echo e(request()->routeIs('admin.colleges.*') || request()->routeIs('admin.offices.*') || request()->routeIs('admin.staff.*') ? 'text-blue-600' : 'text-gray-500 group-hover:text-gray-700'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a
                    ...
                    class="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition
                    <?php echo e(request()->routeIs('admin.devices.*') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-100'); ?>"
                >
                    <svg class="w-5 h-5 <?php echo e(request()->routeIs('admin.devices.*') ? 'text-blue-600' : 'text-gray-500 group-hover:text-gray-700'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a
                    ...
                    class="group flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium transition
                    <?php echo e(request()->routeIs('admin.scanner') ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-100'); ?>"
                >
                    <svg class="w-5 h-5 <?php echo e(request()->routeIs('admin.scanner') ? 'text-blue-600' : 'text-gray-500 group-hover:text-gray-700'); ?>" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="h-16 px-4 sm:px-6 flex items-center justify-between">
                <div class="flex items-center gap-3 min-w-0">
                    ...
                    <h1 class="truncate text-lg sm:text-xl font-semibold text-gray-900">
                        <?php echo $__env->yieldContent('page_title', 'Admin'); ?>
                    </h1>
                </div>
                ...
                <div class="relative shrink-0">
                    ...
                    >
                        <div class="hidden sm:block text-right">
                            ...
                            <div class="text-xs text-gray-500">
                                <?php echo e(auth()->user()->email ?? 'admin@example.com'); ?>
                    ...
                    >
                        ...
                        <div class="py-2">
                            <a href="<?php echo e(route('admin.dashboard')); ?>" class="block px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50">Dashboard</a>
                            <a href="<?php echo e(route('admin.devices.index')); ?>" class="block px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50">Device Manager</a>
                            <a href="<?php echo e(route('admin.scanner')); ?>" class="block px-4 py-2.5 text-sm text-gray-700 hover:bg-gray-50">QR Scanner</a>
